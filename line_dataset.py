...
class LineDataset:
    ...
    def __init__(self, imgW=64, imgH=64, margin=-5, bg_clr=0.5):
        """
        Constructor.
        :param imgW: image width (default 64)
        :param imgH: image height (default 64)
        :param margin: lines segments are sampled within this margin, negative value means that a line segment can
                       start or end outside the image (default -5)
        :param bg_clr: background intensity (default 0.5)
        """
        self.imgW = imgW
        self.imgH = imgH
        self.margin = margin
    ...
    def draw_line(self, data, lX1, lY1, lX2, lY2, clr, alpha=1.0):
        ...
        :param data: image to draw to
        :param lX1: x value of line segment start point
        :param lY1: y value of line segment start point
        :param lX2: x value of line segment end point
        :param lY2: y value of line segment end point
        :param clr: line color, triple of values
        :param alpha: opacity (default 1.0)
        :return:
        """
    ...
    def draw_points(self, points, data, inliers=None):
        ...
        :param points: 2D points, array shape (Nx2xM) where
            N is the number of images in the batch
            2 is the number of point dimensions (x, y)
            M is the number of points
        :param data: batch of images to draw to
        :param inliers: soft inlier score for each point,
