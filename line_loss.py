...
class LineLoss:
    ...
    def __init__(self, image_size):
        """
        Constructor.
        :param image_size: size of the input images, used to normalize the loss
        """
    ...
    def __call__(self, est, gt):
        ...
        :param est: estimated line, form: [intercept, slope]
        :param gt: ground truth line, form: [intercept, slope]
        """
